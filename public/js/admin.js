function drawPage(){
    ...
    if((controller == 'admin' && pageName != '') || controller == 'author'){
...
function drawTable(){
    ...
    if((controller == 'admin' && pageName != '') || controller == 'author'){
        if (pageName == 'users'){
            ...
            $("thead").append(row);
        } else if (pageName == 'wikis'){

        
            $("thead").html("");
            let row = $("<tr>", { class: "bg-black text-white" });
            let element = "";
            wikisColumns.forEach((e) => {
                element = `<th scope="col" class="px-6 py-3 rounded-sm">
                                ${e.toUpperCase()}
                            </th>`;
                row.append(element);
...
function drawForm(){
    ...
    if((controller == 'admin' && pageName != '') || controller == 'author' && pageName != 'users'){
...
function populate(){
    ...
    if(controller == 'admin' || controller == 'author' && pageName != ''){
