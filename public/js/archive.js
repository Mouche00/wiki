function populate(){
        ...
        $.ajax({
            url: URLROOT + '/wikis/displayArchived',
            type: "GET",
            ...
            button = $("<button>", { class: "restore-button", type: "button" });
            button.attr("data-id", `${e.id}`);
            value = `<button class="bg-blue-500 m-1 py-2 px-8 text-white rounded-md">RESTORE</button>`;
            button.html(value);
            element.append(button);
